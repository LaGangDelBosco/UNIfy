...
function build_liked_posts($username)
{
    ...
    if ($result_query->num_rows > 0) {
        while ($row_query = $result_query->fetch_assoc()) {
            ...
            if($_SESSION['Username'] == $post_username) { // TODO: il bottone di elimina e' gigante lmao non so perche'
...
function build_commented_posts($username){
    ...
    if($result_query->num_rows > 0) {
        while ($row_query = $result_query->fetch_assoc()) {
            ...
            if ($_SESSION['Username'] == $post_username) { // TODO: il bottone anche qui e' gigante lmao
